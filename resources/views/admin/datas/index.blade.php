...
@section('content')
  ...
  <div class="content">
    ...
    <div class="col-md-12 text-left">
            <a href="{{route('data.create')}}" class=" btn btn-sm btn-primary"><i class="fa fa-plus"></i> Create New </a><br>
          </div>
</div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">All Data List</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                     <?php $i=1;?>
						              ...
						              <tr>
						               <td>{{$i}}</td>
                                       <td>{{@App\Ebook::where('id', $row->ebook_id)->value('name')}}</td>
						               <td>{{@App\Chapter::where('id', $row->chapter_id)->value('chapter_name')}}</td>
                                       <td>{{$row->page_no}}</td>
                                       <td>{{$row->data}}</td>
						               <td>
