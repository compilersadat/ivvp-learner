    ...
    <div class="card">
      ...
      <div class="card-header"><strong>Update QUESTION</strong></div>
        <div class="card-body card-block">
            <form method="POST" action="{{route('practice.questions.update',$question->id)}}">
                @csrf
        ...
        <div class="form-group row">
            <div class="col-md-6">
                <div class=" pt-2 ">
                    ...
                    <option value="{{$opt->branch_id}}" @if($question->wrtb==$opt->branch_id) selected @endif>{{$opt->name}}</option>
